...
<!--      这里面有修改公告的按钮    -->
        ...
        <Submenu name="6" v-if="myRole!='admin'">
          <template slot="title">
            <Icon type="ios-paper"/>
            <span v-show="isShowAsideTitle">成绩管理</span>
          </template>
          <MenuItem name="" v-if="myRole=='student'">我的成绩</MenuItem>
          <MenuItem name="" v-if="myRole=='teacher'">学生成绩列表</MenuItem>
          <MenuItem name="" v-if="myRole=='teacher'">学生成绩录入</MenuItem>
        </Submenu>
        <Submenu name="7">
          <template slot="title">
            <Icon type="ios-paper"/>
            <span v-show="isShowAsideTitle">个人信息</span>
          </template>
